...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # This assumes virtualbox, but if your docker build fails, its because
  # it got oomkilled, you'll need to 'docker-compose --build --no-cache' in
  # the vagrant machine to retry
